    ...
    <x-app-layout>
        ...
        <div class="py-12">
            <div class="container" style="display: flex; justify-content: center;margin: 10px 0;">
                ">
                <a href="{{ route('task.create') }}" class="button1">Nouvelle tâche</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="centered">
                                    @if (auth()->user()->id === $task->created_by)
                                        <a href="{{ route('task.edit', $task->id) }}" class="button3">Editer</a>
                                    ...
                                    @if ($task->status === 'Non commencé')
                                        <form action="{{ route('task.started', $task->id) }}" method="POST"
